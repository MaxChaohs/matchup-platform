      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 mb-6 border-t-4 border-blue-500">
              ...
              <div className="mt-5 flex items-center justify-center gap-3">
                <button
                  ...
                  className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg flex items-center space-x-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                ...
                {(currentFilters.category || currentFilters.region || currentFilters.dayOfWeek || currentSearchQuery) && (
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-gray-400 to-gray-500 text-white rounded-lg hover:from-gray-500 hover:to-gray-600 transition-all shadow-md hover:shadow-lg flex items-center space-x-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
            ...
            {viewMode === 'team-match' ? (
              <>
                {/* Search Results - 當有任何篩選條件時顯示 */}
                {(currentSearchQuery || currentFilters.category || currentFilters.region || currentFilters.dayOfWeek) && (
